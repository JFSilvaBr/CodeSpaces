package com.sconsole.academy.practice.e01;
...
public class JavaHome extends Application {
    ...
    private void adicionarComponentes(Parent root) {
        ...
        Rectangle rect = new Rectangle(200,200,Color.TEAL);
        ...
        rect.setStroke(Color.MINTCREAM);
